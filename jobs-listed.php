...
<head>
	<title>JNN Campus Recruitment Management System|| Job Listed</title>
...
<body>
	...
	<ol class="breadcrumb justify-content-left">
		...
		<li class="breadcrumb-item active">JNN Campus Drives</li>
	</ol>
	<!-- banner-text -->
	<!-- contact -->
        ...
        <div class="container">
			...
			<!---728x90--->
                <h3 class="tittle text-center mb-lg-4 mb-3">
                    ...
                    <span></span>JNN Campus drive for 2022 batch</h3>
					<!---728x90--->
                <div class="tabs mt-5">
                    <ul class="nav nav-pills my-4" id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Recent Drives</a>
                        </li>
...
?> <div class="job-post-main row">
                                            ...
                                            <div class="col-md-3 job-single-time text-right">
                                                <span class="job-time">
    <a href="single-job-details.php?viewid=<?php echo $row['ID'];?>" class="btn" class="aply-btn " > Details </span></a>
