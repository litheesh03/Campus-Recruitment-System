...
$pagedes=$_POST['pagedes'];
 ...
 $query=mysqli_query($con,"update drive set PageTitle='$pagetitle',PageDescription='$pagedes' where  PageType='aboutus'");
...
<html lang="zxx">
<head>
    <title>JNN Campus Recruitment Management System-About Us</title>
    <!-- CSS -->
...
$ret=mysqli_query($con,"select * from  drive where PageType='aboutus'");
$cnt=1;
...
?>
                                    ...
                                    <div class="form-group col-md-12">
                                        <label for="inputPassword4" class="col-form-label">campus drive details</label>
